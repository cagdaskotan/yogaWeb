...
require_once("core/education/class.subjects.php");
...
<body>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-end">
                                                            ...
                                                            <a href="education-article-manager.php?subject=<?=md5('zsistem'.$x->id)?>" class="btn btn-sm btn-primary btn-icon waves-effect waves-light">
                                                                <i class="ri-add-line" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="İçerik Ekle"></i>
                                                            </a>                                                         
                                                            <a id="<?=$x->education_id?>" data-bs-whatever="<?=$x->id?>" data-bs-toggle="modal" data-bs-target="#edit-sub-modal" class="btn btn-sm btn-secondary btn-icon waves-effect waves-light">
                                                ...
                                                <div class="modal-body">
                                                    <form id="add-sub-form" class="needs-validation" novalidate>
                                                        <div class="row g-3">
                                                            <div class="col-xxl-12">
                                                                <div>
                                                                    <label for="edu-id" class="form-label">Eğitim</label>
                                                                    <select name="education_id" class="form-select" id="edu-id" required>
                                                                        <option value="">Seçiniz...</option>
                                                                        <?php foreach($edu->all() as $x){?>
                                                            ...
                                                            <div class="col-xxl-12">
                                                                <div>
                                                                    <label for="edu-title" class="form-label">Konu</label>
                                                                    <input type="text" name="title" class="form-control" placeholder="Başlık" id="edu-title" required>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-12">
                                                ...
                                                <div class="modal-body">
                                                    <form id="edit-sub-form" class="needs-validation" novalidate>
                                                        <div class="row g-3">
                                                            <div class="col-xxl-12">
                                                                <div>
                                                                    <label for="els-id" class="form-label">Eğitim</label>
                                                                    <select name="education_id" class="form-select" id="els-id" required>
                                                                        <option value="">Seçiniz...</option>
                                                                    </select>
                                                                </div>
                                                            </div>
    ...
    <script>
        ...
        $(document).on('show.bs.modal','#edit-sub-modal', function (t) {
            ...
            var education_id = t.relatedTarget.getAttribute("id");
            $.ajax({
                type: 'POST',
                url: "core/education/api.education.php",
                data: {prep_subject : true, id, education_id},
                success: function(data) {
                    $('#els-id').html(data.education);
