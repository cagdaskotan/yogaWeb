...
require_once("core/lessons/class.articles.php");
                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="lessons-subjects.php">Konular</a></li>
                        ...
                        <div class="col-md-9">
                            <div class="card">
                                ...
                                <div class="card-footer text-end">
                                    <a href="lessons-article-manager.php?subject=<?=$art->subject?>" class="card-link link-secondary"><i class="ri-arrow-left-s-line ms-1 align-middle lh-1"></i> Geri Dön</a>
                                </div>                                
                                ...
                                ?>
                                    <div class="card-body">
                                        ...
                                        <input type="hidden" name="lesson_id" value="<?=$art->subject($subjectHash)->lesson_id?>">
                                    </div>
                                    <div class="card-footer text-end">
                                ...
                                ?>
                                    ...
                                    <div class="card-footer text-end">
                                        ...
                                        <a href="lessons-article-manager.php?subject=<?=$art->subject?>" class="btn btn-danger">Vazgeç</a>
                                    </div>
                                <?php }}?>
                            </div>
                        </div>
                            ...
                            <div data-simplebar data-simplebar-auto-hide="false" style="max-height: 660px;" class="px-3">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-footer">
                                        <div class="clearfix">
                                            <a href="lessons-article-manager.php?subject=<?=$art->subject?>&art=<?=md5('zsistem'.$a->id)?>&read-article" class="card-link link-secondary float-start">Devamını oku <i class="ri-arrow-right-s-line ms-1 align-middle lh-1"></i></a>
                                            ...
                                            <a href="lessons-article-manager.php?subject=<?=$art->subject?>&art=<?=md5('zsistem'.$a->id)?>" class="btn btn-sm btn-secondary btn-icon waves-effect waves-light me-1 float-end" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Düzenle">
            ...
            $('.delete').click(function(e){
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: 'POST',
                            url: 'core/lessons/api.articles.php',
                            ...
                            success: function(data) {
                                ...
                                if(data.status == 200){
                                    ...
                                    setInterval(function(){ window.location.href = 'lessons-article-manager.php?subject=<?= $art->subject ?>&art=<?= $art->article ?>&speech'  }, 900);
                                }
                                if(data.status == 400){
                                    Toastify({
                                        text: data.message,
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if(data.status == 200){
                            ...
                            setInterval(function(){ window.location.href = 'lessons-article-manager.php?subject=<?=$art->subject?>'; }, 2200);
                        }
                    }
                });
            });
