...
require_once("core/about/class.educations.php");
...
<head>
    <meta charset="utf-8" />
    <title>Kişisel Eğitimlerim - Şehirde Yoga Yönetim</title>
...
<body>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Kişisel Eğitimlerim</h4>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card-header">
                                    <div class="d-flex align-items-center flex-wrap gap-2">
                                        <div class="flex-grow-1">
                                            <button class="btn btn-outline-danger add-btn" data-bs-toggle="modal" data-bs-target="#add-education-modal"><i class="ri-add-fill me-1 align-bottom"></i> Kişisel Eğitim Ekle</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                                        ...
                                                        <div class="row g-3">
                                                            <div class="col-xxl-12">
                                                                <div>
                                                                    ...
                                                                    <input type="text" name="description" id="edit-description" class="form-control mt-2" required>
                                                                    <input type="hidden" name="education_id" value="" id="edit-id">
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-12">
                                                                <div class="hstack gap-2 justify-content-end">
    ...
    <script type="text/javascript">
        ...
        $(document).on('submit','#edit-education-form', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: 'core/about/api.educations.php',
                data: formData,
                contentType: false,
                processData: false,
