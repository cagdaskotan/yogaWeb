...
<head>
    <meta charset="utf-8" />
    <title>Kategoriler - Şehirde Yoga Yönetim</title>
...
<body>
                                ...
                                <div class="card-header">
                                    <div class="d-flex align-items-center flex-wrap gap-2">
                                        <div class="flex-grow-1">
                                            <button class="btn btn-outline-danger add-btn" data-bs-toggle="modal" data-bs-target="#add-category-modal"><i class="ri-add-fill me-1 align-bottom"></i> Kategori Ekle</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-xxl-8">
                                            <table id="table-category" class="table table-bordered dt-responsive nowrap table-hover align-middle" style="width:100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?=$x->name?></td>
                                                        <td class="text-end">                                                            
                                                            <a class="btn btn-sm btn-secondary btn-icon waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#edit-category-modal" data-bs-whatever="<?=$x->id?>">
                                    ...
                                    <div class="modal fade" id="add-category-modal" tabindex="-1" aria-labelledby="gr-label"  data-bs-backdrop="static">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="gr-label">Kategori Ekle</h5>
                                    ...
                                    <div class="modal fade" id="edit-category-modal" tabindex="-1" aria-labelledby="gr-label"  data-bs-backdrop="static">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="gr-label">Kategori Düzenle</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <form id="edit-category-form" class="needs-validation" novalidate>
                                                        <div class="row g-3">
                                                            <div class="col-xxl-12">
                                                                <div>
                                                                    <input type="text" name="name" id="edit-name" class="form-control" placeholder="Kategori" required>
                                                                    <input type="hidden" name="id" value="" id="edit-li">
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-12">
                                                                <div class="hstack gap-2 justify-content-end">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body p-5 text-center">
                                                    ...
                                                    <div class="mt-4 text-center">
                                                        <h4 class="fs-semibold">Kategori silinecek ? Emin misiniz?</h4>
    ...
    <script type="text/javascript">
        ...
        $(document).on('submit','#edit-category-form', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: 'core/products/api.categories.php',
                data: formData,
                contentType: false,
                processData: false,
        ...
        $('#delete-record').click(function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: 'core/products/api.categories.php',
                data: {delete_category: true, id: id},
                success: function(data) {
        ...
        $(document).on('show.bs.modal','#edit-category-modal', function (t) {
            var id = t.relatedTarget.getAttribute("data-bs-whatever");
            $.ajax({
                type: 'POST',
                url: 'core/products/api.categories.php',
                data: {get_category: true, id: id},
                success: function(data) {
