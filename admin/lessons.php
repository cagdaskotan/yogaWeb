...
<body>
                                ...
                                <div class="card-header">
                                    <div class="d-flex align-items-center flex-wrap gap-2">
                                        <div class="flex-grow-1">
                                            <button class="btn btn-outline-danger add-btn" data-bs-toggle="modal" data-bs-target="#add-lesson-modal"><i class="ri-add-fill me-1 align-bottom"></i> Ders Ekle</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-xxl-8">
                                            <table id="table-lesson" class="table table-bordered dt-responsive nowrap table-hover align-middle" style="width:100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?=$x->title?></td>
                                                        <td class="text-end">                                                            
                                                            <a class="btn btn-sm btn-secondary btn-icon waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#edit-lesson-modal" data-bs-whatever="<?=$x->id?>">
                                    ...
                                    <div class="modal fade" id="add-lesson-modal" tabindex="-1" aria-labelledby="gr-label"  data-bs-backdrop="static">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="gr-label">Ders Ekle</h5>
                                                    ...
                                                    <form id="add-lesson-form" class="needs-validation" novalidate>
                                                        <div class="row g-3">
                                                            <div class="col-xxl-12">
                                                                <div>
                                                                    <input type="text" name="lesson_title" class="form-control" placeholder="Başlık" required>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-12">
                                    ...
                                    <div class="modal fade" id="edit-lesson-modal" tabindex="-1" aria-labelledby="gr-label"  data-bs-backdrop="static">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="gr-label">Ders Düzenle</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <form id="edit-lesson-form" class="needs-validation" novalidate>
                                                        <div class="row g-3">
                                                            <div class="col-xxl-12">
                                                                <div>
                                                                    <input type="text" name="lesson_title" class="form-control" placeholder="Başlık" id="edit-lt" required>
                                                                    <input type="hidden" name="lesson_id" value="" id="edit-li">
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-12">
                                                                <div class="hstack gap-2 justify-content-end">
    ...
    <script type="text/javascript">
        ...
        //Modal Senders   
        $(document).on('submit','#edit-lesson-form', function(e) {
            e.preventDefault();
            var formData = new FormData(this);
            formData.append('edit_lesson', true);
            $.ajax({
                type: 'POST',
                url: 'core/lessons/api.lessons.php',
                data: formData,
                ...
                success: function(data) {
                    ...
                    $('#edit-lesson-form').trigger('reset');
                    Toastify({
                        text: data.message,
                        duration: 2000,
                        newWindow: true,
        ...
        $(document).on('submit','#add-lesson-form', function(e) {
            e.preventDefault();
            var formData = new FormData(this);
            formData.append('add_lesson', true);
            $.ajax({
                type: 'POST',
                url: 'core/lessons/api.lessons.php',
                data: formData,
        ...
        $(document).on('show.bs.modal','#edit-lesson-modal', function (t) {
            var id = t.relatedTarget.getAttribute("data-bs-whatever");
            $.ajax({
                type: 'POST',
                url: 'core/lessons/api.lessons.php',
                data: {get_lesson: true, id: id},
                success: function(data) {
